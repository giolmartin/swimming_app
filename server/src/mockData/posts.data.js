const MOCK_POSTS = [
  ...
  {
    title: '10 Essential Swimming Techniques for Beginners',
    subtitle: 'Master the Basics and Improve Your Swimming Skills',
    author: 'Jane Smith',
    date: new Date('2023-04-12T14:30:00.000Z'),
    introduction:
      'In this article, we will discuss 10 essential swimming techniques for beginners...',
    sections: [
      {
        sectionTitle: 'The Freestyle Stroke',
        contentType: 'text',
        content: 'The freestyle stroke is also known as the front crawl...',
      },
    ],
    conclusion:
      'In conclusion, learning these 10 essential swimming techniques...',
    imageUrl: 'https://example.com/images/swimming-techniques.jpg',
    views: 210,
    categories: ['technique'],
    tags: ['swimming techniques', 'learn to swim'],
  },
  {
    title: 'The Ultimate Guide to Swim Gear for All Levels',
    subtitle: 'From Swimwear to Training Aids, What You Need to Know',
    author: 'John Doe',
    date: new Date('2023-02-12T14:30:00.000Z'),
    introduction:
      'In this comprehensive guide, we will cover various types of swim gear...',
    sections: [
      {
        sectionTitle: 'Swimwear',
        contentType: 'text',
        content:
          'Choosing the right swimwear is crucial for comfort and performance...',
      },
    ],
    conclusion:
      'In conclusion, understanding the different types of swim gear...',
    imageUrl: 'https://example.com/images/swim-gear-guide.jpg',
    views: 210,
    categories: ['gear'],
    tags: ['swim gear', 'swimwear', 'swim caps', 'goggles'],
  },
  {
    title: '5 Nutrition Tips for Swimmers to Improve Performance',
    subtitle: 'Fuel Your Body for Optimal Swimming Results',
    author: 'Jane Smith',
    date: new Date('2023-04-02T14:30:00.000Z'),
    introduction:
      'In this article, we will discuss 5 nutrition tips for swimmers...',
    sections: [
      {
        sectionTitle: 'Balanced Diet',
        contentType: 'text',
        content:
          'A balanced diet is essential for swimmers to perform at their best...',
      },
    ],
    conclusion: 'In conclusion, these 5 nutrition tips will help swimmers...',
    imageUrl: 'https://example.com/images/nutrition-tips-swimmers.jpg',
    views: 210,
    categories: ['nutrition'],
    tags: ['nutrition', 'hydration', 'meal planning', 'sports supplements'],
  },
  {
    title: 'Mastering the Freestyle Technique',
    subtitle: 'Improve your swimming speed and efficiency',
